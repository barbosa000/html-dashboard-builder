  ...
  return (
    <>
      <Panel
        ...
        subtitle='Campos editáveis — preencha com a pesquisa real. Sem dado, aparece "A validar".'
      >
        <DataTable
          columns={[
            "Segmento",
      ...
      <Panel
        className="mt-4"
        title="Matriz Volume × Recorrência"
        subtitle="Tamanho da bolha = prioridade"
      >
        <div className="h-72">
            ...
            <ScatterChart margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
              ...
              <Tooltip
                ...
                formatter={(value, name, props: any) =>
                  name === "z" ? [props.payload.label, "Segmento"] : [value, name]
                }
              />
          ...
          {points.length === 0 && (
            <p className="mt-2 text-center text-xs text-muted-foreground">
              Preencha volume e recorrência dos segmentos para ver a matriz.
            </p>
          )}
        </div>
      </Panel>
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Segmentos de cliente, matriz de priorização e anotações de campo na RMC."
      />

      <SegmentsCard />

      <SectionTitle>Mapa de demanda por região</SectionTitle>
      <DemandMap />
      ...
      <CrudSection
        ...
        fields={[
          {
            ...
            label: "Área",
            type: "select",
            options: ["Campo Magro", "Curitiba", "Região Metropolitana"],
          },
          {
            key: "type",
            label: "Tipo",
        ...
        columns={[
          { key: "area", label: "Área" },
          {
            ...
            label: "Tipo",
            render: (r) => (
              <Chip value={r.type} kind={r.type === "Risco" ? "critical" : "neutral"} />
            ),
          },
