...
export const Route = createFileRoute("/_authenticated/documentacao")({ component: DocumentacaoPage });
...
function DocumentacaoPage() {
  ...
  return (
    <div>
      <PageHeader title="Documentação" description="Biblioteca de documentos, licenças e órgãos responsáveis." />
      ...
      <div className="mt-6">
        <CrudSection
          ...
          fields={[
            { key: "document", label: "Documento", required: true, span: 2, placeholder: "Ex.: Alvará sanitário" },
            { key: "agency", label: "Órgão", placeholder: "Ex.: Vigilância Sanitária" },
            { key: "status", label: "Status", type: "select", options: ["Pendente", "Em análise", "Emitido", "Vencido"] },
